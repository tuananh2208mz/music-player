...
const AudioPlayer = {
    ...
    init() {
        ...
        // Bắt sự kiện phát và đồng bộ trạng thái ngầm
    ...
    async loadSong(index) {
        ...
        // Cập nhật thông tin Media Session cho màn hình khóa
    ...
    // Cấu hình Media Session để phát nhạc dưới nền và nhận lệnh từ màn hình khóa
